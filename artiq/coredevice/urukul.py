...
from artiq.coredevice.ttl import TTLClockGen, TTLOut
...
class CPLDVersion:
    ...
    @kernel
    def cfg_write(self, cpld: CPLD[T], cfg: int64):
        pass

    @kernel
    def sta_read(self, cpld: CPLD[T]) -> int32:
        return int32(0)

    @kernel
    def init(self, cpld: CPLD[T]):
        pass

    @kernel
    def io_rst(self, cpld: CPLD[T]):
        pass

    @kernel
    def set_profile(self, cpld: CPLD[T], channel: int32, profile: int32):
        pass
    ...
    @kernel
    def _configure_all_bits(self, cpld: CPLD[T], bit_offset: int32, state: int32):
        pass

    @kernel
    def cfg_mask_nu(self, cpld: CPLD[T], channel: int32, on: bool):
        pass

    @kernel
    def cfg_mask_nu_all(self, cpld: CPLD[T], state: int32):
        pass
    ...
    @kernel
    def cfg_att_en(self, cpld: CPLD[T], channel: int32, on: bool):
        self._not_implemented()

    @kernel
    def cfg_att_en_all(self, cpld: CPLD[T], state: int32):
        self._not_implemented()

    @kernel
    def cfg_osk(self, cpld: CPLD[T], channel: int32, on: bool):
        self._not_implemented()

    @kernel
    def cfg_osk_all(self, cpld: CPLD[T], state: int32):
        self._not_implemented()

    @kernel
    def cfg_drctl(self, cpld: CPLD[T], channel: int32, on: bool):
        self._not_implemented()

    @kernel
    def cfg_drctl_all(self, cpld: CPLD[T], state: int32):
        self._not_implemented()

    @kernel
    def cfg_drhold(self, cpld: CPLD[T], channel: int32, on: bool):
        self._not_implemented()

    @kernel
    def cfg_drhold_all(self, cpld: CPLD[T], state: int32):
        self._not_implemented()
...
class ProtoRev8(CPLDVersion):
    ...
    @kernel
    def _configure_bit(
        self, cpld: CPLD[T], bit_offset: int32, channel: int32, on: bool
    ):
...
T = TypeVar("T", ProtoRev8, ProtoRev9)


@compile
class CPLD(Generic[T]):
    ...
    def sta_read(self) -> int32:
        self.version.sta_read(self)
        # if self.proto_rev == STA_PROTO_REV_8:
        #     self.version8.sta_read(self)
        # elif self.proto_rev == STA_PROTO_REV_9:
        #     self.version9.sta_read(self)
    ...
    def cfg_att_en(self, channel: int32, on: bool):
        ...
        # if self.proto_rev == STA_PROTO_REV_8:
        #     self.version8.cfg_att_en(self, channel, on)
        # elif self.proto_rev == STA_PROTO_REV_9:
    ...
    def cfg_att_en_all(self, state: int32):
        ...
        # if self.proto_rev == STA_PROTO_REV_8:
        #     self.version8.cfg_att_en_all(self, state)
        # elif self.proto_rev == STA_PROTO_REV_9:
    ...
    def cfg_osk(self, channel: int32, on: bool):
        ...
        # if self.proto_rev == STA_PROTO_REV_8:
        #     self.version8.cfg_osk(self, channel, on)
        # elif self.proto_rev == STA_PROTO_REV_9:
    ...
    def cfg_osk_all(self, state: int32):
        ...
        # if self.proto_rev == STA_PROTO_REV_8:
        #     self.version8.cfg_osk_all(self, state)
        # elif self.proto_rev == STA_PROTO_REV_9:
    ...
    def cfg_drctl(self, channel: int32, on: bool):
        ...
        # if self.proto_rev == STA_PROTO_REV_8:
        #     self.version8.cfg_drctl(self, channel, on)
        # elif self.proto_rev == STA_PROTO_REV_9:
    ...
    def cfg_drctl_all(self, state: int32):
        ...
        # if self.proto_rev == STA_PROTO_REV_8:
        #     self.version8.cfg_drctl_all(self, state)
        # elif self.proto_rev == STA_PROTO_REV_9:
    ...
    def cfg_drhold(self, channel: int32, on: bool):
        ...
        # if self.proto_rev == STA_PROTO_REV_8:
        #     self.version8.cfg_drhold(self, channel, on)
        # elif self.proto_rev == STA_PROTO_REV_9:
    ...
    def cfg_drhold_all(self, state: int32):
        ...
        # if self.proto_rev == STA_PROTO_REV_8:
        #     self.version8.cfg_drhold_all(self, state)
        # elif self.proto_rev == STA_PROTO_REV_9:
